        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-white/40">Manage your real estate visual assets</p>
                </div>
                <Link href="/visual-engine/new">
                    <Button className="bg-white text-black hover:bg-white/90 rounded-full px-6 h-12 shadow-[0_0_20px_rgba(255,255,255,0.15)]">
